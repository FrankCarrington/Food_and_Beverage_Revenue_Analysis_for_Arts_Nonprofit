/* This query provides a quarterly sales summary for an entertainment venue using a July–June fiscal year. 
The report combines box office ticket sales with food and beverage revenue to provide a comprehensive view of sales performance. */
